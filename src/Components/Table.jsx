    ...
    <TableHead>
      <TableRow>
        <TableCell
          ...
          padding="10px"
          sx={{ marginRight: "20px", cursor: "pointer", fontWeight: "700" }}
        >
          {numSelected > 0 ? t("RemoveAll") : t("SelectAll")}
        </TableCell>
                  ...
                  return (
                    ...
                    >
                      <TableCell padding="checkbox">
                        <Checkbox
                          onChange={(event) => handleClick(user?._id)}
                          color="primary"
